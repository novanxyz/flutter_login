...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthStatus authStatus, UserModel? user});
...
class _$AuthStateImpl implements _AuthState {
  _$AuthStateImpl({this.authStatus = AuthStatus.unAuthenticated, this.user});
...
abstract class _AuthState implements AuthState {
  factory _AuthState({final AuthStatus authStatus, final UserModel? user}) =
      _$AuthStateImpl;

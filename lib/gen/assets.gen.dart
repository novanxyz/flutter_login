...
class $AssetsLogoGen {
  ...
  /// File path: assets/logo/logo-only.png
  AssetGenImage get logoOnly =>
      const AssetGenImage('assets/logo/logo-only.png');

  /// File path: assets/logo/logo.png
  AssetGenImage get logo => const AssetGenImage('assets/logo/logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [googleLogo, logoOnly, logo];
}
